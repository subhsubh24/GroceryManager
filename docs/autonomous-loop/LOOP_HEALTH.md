...
LOOP_HEALTH:
  ...
  signal: steady                 # bootstrapping | improving | steady | churning | stuck
                                 #   run 65: 6-Haiku scout sweep (deep audit NOT due, run 63 <24h) + 3 file-disjoint clears. #527 (FLAGSHIP —

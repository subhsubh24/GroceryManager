...
/* Offline support: cache-first for static assets; network-first for navigations with a cache (then
 * home) fallback, so the pantry + shopping list show their last-seen state in-store with no signal. */
